...
public class AddressbookController {
    ...
    public ResponseEntity<ResponseDTO> getAddressbookData() {
        ...
        addressbookData = new AddressbookData(1,new AddressbookDTO("Ashvini","7000598464"));
    ...
    public ResponseEntity<ResponseDTO> getAddressbookData(@PathVariable(value = "personId") int personId) {
        AddressbookData addressbookData = null;
        addressbookData = new AddressbookData(personId,new AddressbookDTO("Tarun","6269436775"));
